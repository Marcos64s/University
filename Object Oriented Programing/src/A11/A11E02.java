...
// adicionar, remover, ordenar, garantir elementos únicos
	...
	Localidade Agueda = new Localidade("Agueda", 47000,TipoLocalidade.Cidade);
	Localidade Vagueira = new Localidade("Vagueira", 2000,TipoLocalidade.Vila);
	
	Estado  Aveiro= new Estado("Aveiro", 78500, Agueda);
	
	List<Pais> Portugal = new ArrayList<Pais>();
