...
Xcircle=cos(a);
Ycircle=sin(a);
GM1=patch (X1(1)+r1*Xcircle, X1(2)+r1*Ycircle,'r','FaceAlpha',0.2);
grid on;
axis square equal;
hold on;
patch([0,0,14,14],[0,10,10,0],'w','FaceAlpha',0.4);
GM2=patch (X2(1)+r2*Xcircle, X2(2)+r2*Ycircle,'b','FaceAlpha',0.2);
