...
% Last Modified by GUIDE v2.5 09-May-2018 10:42:02
...
set(handles.inicio, 'ForegroundColor', [1 0 0])
set(handles.inicio, 'FontSize',12)
...
set(handles.inicio, 'String', 'AGUARDE....')
x = -2:0.1:2;
y = -alpha.*x.^2+x.^4+6;
plot(handles.axes1,x,y,'-','Linewidth', 2)

set(handles.inicio, 'String', 'Clique aqui!')
