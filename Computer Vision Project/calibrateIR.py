...
if (isRGB):
    img_names = glob('calibrateIR/*.png')
...
np.savez("img_pointsIR.npz",img_pointsIR=img_points)
np.savez("kinect paramsIR.npz",camera_matrix=camera_matrix,dist_coefs=dist_coefs)
